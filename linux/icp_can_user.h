...
#define ICP_CAN_IO_FILTER_GET	_IOR(MAGIC, 5, icp_can_rx_filter_t)
...
#define ICP_CAN_IO_BUFFER_LINK_SET	_IO(MAGIC, 22)
#define ICP_CAN_IO_BUFFER_LINK_CLEAR	_IO(MAGIC, 23)
#define ICP_CAN_IO_BUFFER_LINK_GET	_IOR(MAGIC, 24, unsigned int)

#define ICP_CAN_IO_RX_ENABLE_SET	_IO(MAGIC, 25)
#define ICP_CAN_IO_RX_ENABLE_CLEAR	_IO(MAGIC, 26)
#define ICP_CAN_IO_RX_ENABLE_GET	_IOR(MAGIC, 27, unsigned int)

#define ICP_CAN_IO_TX_ENABLE_SET	_IO(MAGIC, 28)
#define ICP_CAN_IO_TX_ENABLE_CLEAR	_IO(MAGIC, 29)
#define ICP_CAN_IO_TX_ENABLE_GET	_IOR(MAGIC, 30, unsigned int)


#endif /* __ICP_CAN_USER_H__ */
